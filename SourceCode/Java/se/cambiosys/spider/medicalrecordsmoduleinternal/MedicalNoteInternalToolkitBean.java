...
public class MedicalNoteInternalToolkitBean extends InternalToolkit
{
  ...
  /** this method will return list of Unsigned TrainingMedicalNoteData objects for given arguments
   *
   * @ejbgen:remote-method
   * @param contactIds
   * @return
   * @throws SpiderException
   */
  public List<TrainingMedicalNoteData>  getUnsignedData(long[] contactIds , long[] unitIds , long[] careProviders)throws SpiderException
  {
    return MedicalNoteStorageInternelToolkit.getInstance().getUnsignedMedicalNotes(contactIds,unitIds,careProviders);
  }


  /** this method will return list of TrainingMedicalNoteData objects for given contactId
   *
   * @ejbgen:remote-method
   * @param contactId
   * @return
  ...
  {
    return MedicalNoteStorageInternelToolkit.getInstance().getMedicalNoteDataByContactId(contactId);
  }

  /** this method will return list of All Unsigned TrainingMedicalNoteData
   *
   * @ejbgen:remote-method
   * @param unitIds
   * @param careProviders
   ...
   * @throws SpiderException
   */
  public List<TrainingMedicalNoteData> getAllUnsignedData(long[] unitIds , long[] careProviders)throws
    SpiderException
  {
    return MedicalNoteStorageInternelToolkit.getInstance().getAllUnsignedMedicalNotes(unitIds,careProviders);
  }

  /** this method will return latest TrainingMedicalNoteData for given Id
   *
   * @ejbgen:remote-method
   * @param Id
   * @return TrainingMedicalNoteData
   * @throws SpiderException
   */
  public TrainingMedicalNoteData getDataById(long Id)throws SpiderException
  {
    return MedicalNoteStorageInternelToolkit.getInstance().getDataById(Id);
  }
