...
public class MedicalNoteStorageInternelToolkit implements MedicalNoteStorageInternelToolkitService
{
  ...
  public List<TrainingMedicalNoteData> getDataByKeys(long[] keys)throws SpiderException
  {
    ...
    Collection<TrainingMedicalNoteData> dbResult =  CambioStorageAdaptor.getInstance().findByClass(storageArea,
                                                                                         TrainingMedicalNoteData.class, getWhereClause(PRIMARY_KEY, keys) + " AND active = 1");
  ...
  /** method to return List of TrainingMedicalNoteData for given contactId
   * @param contactId
   * @return
   * @throws SpiderException
   */
  @Override
  public List<TrainingMedicalNoteData> getMedicalNoteDataByContactId(long contactId)throws SpiderException
  {
    List<TrainingMedicalNoteData> medicalNoteList = new ArrayList<TrainingMedicalNoteData>();
    ...
    Collection<TrainingMedicalNoteData> dbResult =  CambioStorageAdaptor.getInstance().findByClass(storageArea,
    TrainingMedicalNoteData.class, getWhereClause(CONTACT, new long[]{contactId}) + " AND latest = 1 AND active = 1");
  ...
  @Override
  public List<TrainingMedicalNoteData> getUnsignedMedicalNotes(long[] contactIds, long[] unitIds , long[] careProviders)throws SpiderException
  {
    List<TrainingMedicalNoteData> medicalNoteList = new ArrayList<TrainingMedicalNoteData>();
    ...
    Collection<TrainingMedicalNoteData> dbResult =  CambioStorageAdaptor.getInstance().findByClass(storageArea,
                                                                                                   TrainingMedicalNoteData.class, getWhereClause(CONTACT, contactIds) + " AND latest = 1 AND signed = 0 AND active = 1 AND " + getWhereClause(UNIT,unitIds) + " AND " + getWhereClause(CARE_PROVIDER,careProviders));
  ...
  @Override
  public List<TrainingMedicalNoteData> getAllUnsignedMedicalNotes(long[] unitIds , long[] careProviders)throws SpiderException
  {
    List<TrainingMedicalNoteData> medicalNoteList = new ArrayList<TrainingMedicalNoteData>();

    final StorageArea storageArea = StorageManager.getStorage(getStorage()).getArea(getStorageArea());

    Collection<TrainingMedicalNoteData> dbResult = CambioStorageAdaptor.getInstance().findByClass(storageArea,TrainingMedicalNoteData.class,getWhereClause(UNIT,unitIds) + " AND " + getWhereClause(CARE_PROVIDER,careProviders)+" AND latest = 1 AND signed = 0 AND active = 1");
  ...
  @Override
  public TrainingMedicalNoteData getDataById(long Id)throws  SpiderException
  {
    final StorageArea storageArea = StorageManager.getStorage(getStorage()).getArea(getStorageArea());

    Collection<TrainingMedicalNoteData> dbResult = CambioStorageAdaptor.getInstance().findByClass(storageArea,TrainingMedicalNoteData.class,getWhereClause(ID,new long[]{Id})   +" AND latest = 1 AND active = 1");
