...
public class MedicalNoteToolkit
{
  ...
  /**
   * This method will return List of TrainingMedicalNoteData List given contactId
   *
   * @param contactId
   * @return
   * @throws SpiderException
  ...
  public List<TrainingMedicalNoteData> getMedicalNoteDataByContactId(long contactId)throws SpiderException
  {
    try
    {
      return getInternalBean().getMedicalNoteDataByContactId(contactId);
    }
    catch (RemoteException e)
    {
      DefaultExceptionHandler.getInstance().handleThrowable(e);
  ...
  /**
   * This method will return List of Unsigned TrainingMedicalNoteData List given contactId
   *
   * @param contactIds
   * @return
   * @throws SpiderException
   */
  public List<TrainingMedicalNoteData> getUnsignedData(long[] contactIds , long[] unitIds , long[] carProviders)throws SpiderException
  {
    try
    {
      return getInternalBean().getUnsignedData(contactIds,unitIds,carProviders);
    }
    catch (RemoteException e)
    {
      DefaultExceptionHandler.getInstance().handleThrowable(e);
  ...
  /**
   * This method will return List of  All Unsigned TrainingMedicalNoteData List given contactId
   *
   * @param unitIds , careProviders
   * @return
   * @throws SpiderException
   */
  public List<TrainingMedicalNoteData> getAllUnsignedData(long[] unitIds , long[] careProviders)throws SpiderException
  {
    try
    {
      return getInternalBean().getAllUnsignedData(unitIds,careProviders);
    }
    catch (RemoteException e)
    {
      DefaultExceptionHandler.getInstance().handleThrowable(e);
  ...
  public TrainingMedicalNoteData getDataById(long Id)throws SpiderException
  {
    try
    {
      return getInternalBean().getDataById(Id);
    }
    catch (RemoteException e)
    {
      DefaultExceptionHandler.getInstance().handleThrowable(e);
