...
public class MedicalRecordManagerBean extends ManagerBeanBase
{
  ...
  /**
   * return TrainingMedicalNoteData list for given contactId
   *
   * @ejbgen:remote-method
   *
   * @param contactId
  ...
  {
    return MedicalNoteToolkit.getInstance().getMedicalNoteDataByContactId(contactId);
  }

  /**
   * return Unsigned TrainingMedicalNoteData list for given arguments
   *
   * @ejbgen:remote-method
   *
   * @param contactIds
  ...
  {
    return MedicalNoteToolkit.getInstance().getUnsignedData(contactIds , unitIds ,careProviders );
  }


  /**
   * return All Unsigned TrainingMedicalNoteData list for given arguments
   *
   * @ejbgen:remote-method
   *
  ...
  {
    return MedicalNoteToolkit.getInstance().getAllUnsignedData(unitIds ,careProviders );
  }

  /**
   * return latest TrainingMedicalNoteData for given Id
   *
   * @ejbgen:remote-method
   *
   * @param Id
  ...
  {
    return MedicalNoteToolkit.getInstance().getDataById(Id);
  }
